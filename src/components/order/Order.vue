...
<template>
<!--  <h1>{{this.$route.path}} : {{this.$route.params}}</h1>-->
  <div class="content-container" direction="vertical">
    ...
    <div class="content-row">
      <el-container>
        <el-button typeof="primary" @click="requestData">筛选</el-button>
        <el-button typeof="danger" @click="clear">清空筛选</el-button>
        <el-button typeof="primary" @click="exportData">导出</el-button>
        <el-button typeof="primary" @click="dispatchGoods">批量发货</el-button>
        <el-button typeof="primary" @click="exportDispatchGoods">下载批量发货样单</el-button>
      </el-container>
    </div>
    <div>
